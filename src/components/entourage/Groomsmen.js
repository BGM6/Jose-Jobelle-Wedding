					...
					<Card style={{margin: '0.5rem'}}>
						...
						<Card.Body>
							...
							<Card.Text>
								...
								crack a joke that will brighten anyone’s day and always ready to have a good time. They have a
								friendship that will last a lifetime. Jose couldn’t just have one best man on his special day!
							</Card.Text>
						</Card.Body>
					</Card>
					<Card style={{margin: '0.5rem'}}>
						...
						<Card.Body>
							...
							<Card.Text>
								...
								one can break. Jose couldn’t of asked for any one else to bless & honor him on his special day.
							</Card.Text>
						</Card.Body>
					</Card>
				</CardGroup>
